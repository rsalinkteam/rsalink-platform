/*
Website:        RSA Archer Suite Training (https://community.rsa.com/community/training/archer)
Iteration:      RSA University Redesign July 2019
Scope:          RSA Archer Suite Training space
...
var app = angular.module('ngchangeApp', ['angularjs-dropdown-multiselect']);
        ...
        app.controller('ngApp', function($scope) {
            ...
            $scope.init = function () {                
                ...
                jive_widget_container_large.find(".masterDocument tbody tr td:nth-child(1)").filter(function() {return $(this).text().toLowerCase().split(/[\s,]+/).includes("customers") == true}).parent('tr').filter(function() {return $(this).find("td:nth-child(2)").text().toLowerCase() == "arch";}).find("a").attr("target", "_top");
